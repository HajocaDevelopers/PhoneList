<%@ Page Title="Hajoca Interactive Directory" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="InteractiveDirectory.Default" %>
    ...
    <%@ Register Src="~/ViewSwitcher.ascx" TagPrefix="friendlyUrls" TagName="ViewSwitcher" %>
        ...
        <asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
            <div id="ng-app" ng-app="interactiveDirectoryApp">
                <div ng-controller="appCtrl">
                    ...
                    <div id="mainContainer">
                            ...
                            <div id="divHeaderRight" class="blockContent">
                                <div id="divDirectory" class="blockContent">
                                    ...
                                    <select ng-model="view" class="form-control" data-style="btn-primary">
                                        ...
                                        <option value="4">Service Centers</option>
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" href="#directory" role="tab" data-toggle="tab">Directory</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#regionMap" role="tab" data-toggle="tab">Region Map</a>
                            </li>
                        </ul>
                        <div class="tab-content">
                            <div id="directory" class="tab-pane active" role="tabpanel" ng-show="doneInitialLoading">
                            ...
                            <div id="regionMap" role="tabpanel" class="tab-pane">
