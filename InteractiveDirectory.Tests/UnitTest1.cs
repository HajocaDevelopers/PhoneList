...
namespace InteractiveDirectory.Tests
{
    ...
    public class UnitTest1
    {
        ...
        public void BuildRegionName()
        {
            ...
            RegionNames.Add(4,"MIDWEST REGION");
            RegionNames.Add(6,"SOUTH CENTRAL REGION");
            RegionNames.Add(7,"NORTH CENTRAL REGION");
            RegionNames.Add(8,"PACIFIC REGION");
            RegionNames.Add(11,"NORTHWEST REGION");
            RegionNames.Add(12,"SOUTH FLORIDA REGION");
            RegionNames.Add(13,"CHESAPEAKE REGION");
            RegionNames.Add(140,"NEW VENTURES REGION");
            RegionNames.Add(200, "NORTH FLORIDA REGION");
            RegionNames.Add(300,"NORTH TEXAS REGION");
            RegionNames.Add(301,"SOUTH TEXAS REGION");
            RegionNames.Add(305,"CAROLINAS REGION");
            RegionNames.Add(306,"SOUTHEAST REGION");
            RegionNames.Add(308,"SOUTHERN CALIF REG");
            File.Delete("c:\\RegionNames.xml");
            Stream stream = File.Open("c:\\RegionNames.xml", FileMode.Create, FileAccess.ReadWrite);
            ...
            Stream streamIN = File.Open("c:\\RegionNames.xml", FileMode.Open, FileAccess.Read);
